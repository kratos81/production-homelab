...
### Performance
- 2 replicas provide a good balance between redundancy and write performance on Proxmox VE
...
- Longhorn on Proxmox: https://docs.longhorn.io/v1.2/advanced/longhorn
