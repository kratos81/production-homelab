...
GitLab Community Edition provides Git repository hosting, CI/CD pipelines, and code collaboration for the platform. It is deployed as a minimal installation with non-essential components disabled to conserve resources on the Proxmox VE cluster.
